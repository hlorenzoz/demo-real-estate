        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div 
              ...
              className="absolute top-[calc(100%+12px)] left-0 right-0 bg-white/95 backdrop-blur-3xl rounded-[32px] border border-white/40 shadow-[0_20px_50px_rgba(0,0,0,0.2)] p-6 min-[1100px]:hidden z-[10000]"
            >
