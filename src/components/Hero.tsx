    ...
    <section className="relative h-screen flex items-center pt-20 overflow-hidden bg-primary">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 w-full mt-[-10vh]">
        <div className="max-w-2xl text-white">
          ...
          <h1 className="text-6xl md:text-8xl font-serif mb-8 leading-[1.1] tracking-tighter animate-fade-in" style={{ animationDelay: '0.1s' }}>
            {dict.title} <span className="gold-gradient italic">{dict.title_accent}</span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-12 leading-relaxed font-light max-w-xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
            {dict.subtitle}
          </p>
