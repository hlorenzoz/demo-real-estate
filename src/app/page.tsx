    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <Image 
            src="https://cdn.hlorenzoz.com/images/inmobiliary-inmo3/hero.webp" 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass overflow-hidden rounded-[32px] flex flex-col lg:flex-row shadow-2xl">
            <div className="lg:w-1/2 relative h-80 lg:h-auto">
              <Image src="https://cdn.hlorenzoz.com/images/inmobiliary-inmo3/services.webp" alt="Asesoramiento profesional" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-20 flex flex-col lg:flex-row items-center gap-12 p-8 glass rounded-[32px]">
            <div className="lg:w-1/3 relative h-[400px] w-full rounded-2xl overflow-hidden">
              <Image src="https://cdn.hlorenzoz.com/images/inmobiliary-inmo3/team.webp" alt="Equipo INMO3" fill sizes="(max-width: 1024px) 100vw, 33vw" className="object-cover" />
            </div>
