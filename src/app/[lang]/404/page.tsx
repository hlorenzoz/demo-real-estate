 ...
 * 404 PAGE COMPONENT
 * -------------------
 * This is the unified 404 destination for all languages.
 * It provides a premium, high-converting "not found" experience.
 */
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
      ...
      <footer className="p-10 border-t border-slate-50 flex justify-center text-xs font-bold text-slate-300 uppercase tracking-widest">
         © 2026 Luxury Living Estate · Unified 404 Experience
      </footer>
    </div>
  );
}
