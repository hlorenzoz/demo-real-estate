# SPEC.md - INMO3 Technical Specification
...
- Manifest and Service Worker configured for INMO3 branding.

### 2. SEO & GEO
- Metadata API in `layout.tsx`.
- JSON-LD Rich Results for `RealEstateAgent` (Xinzo de Limia coordinates).
...
- `/public/images`: Optimized WebP/PNG assets from Nano Banana Pro.
